...
metadata:
  sources:
    - kind: github-file
      ...
      path: document-generate/SKILL.md
      commit: 25cf5edf210fee2cd296ffb2dfb2eff370ebcf35
      sha256: 6d00efd0f3fc06ec138cad5b64daae2ea28e92b0631fba60e644a006ef47f6da
      attribution: gstack / Garry Tan
      license: MIT
      usage: transformed
  paperclip:
    imported_at: 2026-05-15T05:31:05.495Z
    importer_version: 0.1.0
    transformation: gstack-preamble-patched
    source_command: /document-generate
    original_name: document-generate
---
...
## Preamble (Paperclip mode)

> _The original gstack `## Preamble (run first)` block invoked helpers from_
> _`~/.claude/skills/gstack/bin/...` and state files under `~/.gstack/...`._
> _Those paths do not exist inside a Paperclip deployment, so the bash_
> _preamble has been removed by `scripts/patch-gstack-preambles.ts`._
> _Continue with the next section._
